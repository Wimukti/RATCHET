...
if __name__ == '__main__':
    ...
    csv_root = '../preprocessing/iu-xray'
    vocab_root = '../preprocessing/iu-xray'
    mimic_root = '../IU_XRAY/images'

    train_dataset, _ = get_iu_xray_dataset(csv_root, mimic_root, vocab_root)
